...
(function(document, $) {
    ...
    $(document).on("foundation-contentloaded", function(e) {
        ...
        showHide($(".cq-dialog-dropdown-showhide-multi", e.target));
    });
   ...
   function showHide(el){
       ...
       el.each(function(i, element) {
           ...
           if (widget) {
               ...
               var target = $(element).data("cqDialogDropdownShowhideMultiTarget");
               ...
               $(target).filter("[data-showhidetargetvaluemulti]").each(function(j, d) {
                   var v = $(d).attr("data-showhidetargetvaluemulti");

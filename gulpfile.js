...
var root        = 'ui.apps/src/main/content/jcr_root/',
    components  = root + 'apps/pall/components/',
    designs     = root + 'etc/designs/pall/',
    clientlibs = root + 'etc/clientlibs/pall/',

    // Styles
    cssPath     = clientlibs + 'css/',
    sassPath    = clientlibs + 'sass/',
